...
import org.netbeans.modules.python.testrunner.PythonCodeCoverageProvider;
        ...
        public void invokeAction(String string, Lookup lkp)
            ...
            switch (string) {
                ...
                case ActionProvider.COMMAND_RUN_SINGLE:
                    PythonRun.runAction(project, lkp.lookup(DataObject.class));
                    break;
                case ActionProvider.COMMAND_RUN:
                    ...
                    PythonRun.runAction(project, get != null
                            ? DataObject.find(FileUtil.toFileObject(new File(get
                                    .toString())))
                            : DataObject.find(projectDir.getFileObject("main.py")));
